...
public class e {
    ...
    public static boolean pos(long mid, long low, long high){
        long val1 = find(low, mid);
        long val2 = find(mid+1, high);
        return val1<=val2;
    }
    public static void solve(){
        ...
        long ret = Math.abs(find(k, ans)-find(ans+1, k+n-1));
        if(ans+2<=n+k-1) ret = Math.min(ret, Math.abs(find(k, ans+1)- find(ans+2, k+n-1)));
        fw.println(ret);
    }
