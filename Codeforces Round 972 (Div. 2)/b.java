...
public class b {
    ...
    public static void solve(){
        ...
        while(q-->0){
            ...
            if(lef==0){
                ans = Math.min(ans, rig-1);
            }
            if(rig==n+1){
                ans = Math.min(ans, n-lef);
            }
            if(lef!=0 && rig!=n+1){
                ans = Math.min(ans, (rig-lef)/2);
            }
            fw.println(ans);
        }
    ...
    public static int bs1(int a[], int n, int val){
        int low = 0;
        int high = a.length;
        int ans = 0;
        while(low<high){
    ...
    public static int bs2(int a[], int n, int val){
        int low = 0;
        int high = a.length;
        int ans = n+1;
        while(low<high){
